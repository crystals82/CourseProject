...
class NLPTweet:
    ...
    def _from_tweepy(self, tweet):
        ...
        self.date = tweet.created_at.astimezone(datetime.timezone.utc)
    ...
    def _from_sn(self, tweet):
        ...
        self.date = tweet.date.astimezone(datetime.timezone.utc)
...
def search_tweets_tweepy(q,
    ...
    if until < (datetime.datetime.now() - datetime.timedelta(days=7)):
        raise ValueError(
